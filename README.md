...
このソースコードは、[Code2012 イベント](http://codejapan.jp) 用に企画された、「何故あなたはコードを書くのでしょうか?」アンケートの、フロントエンド側 UI アプリです。
...
バックエンド側 API
----------------
このアプリから、Ruby on Rails で作成・Heroku に配置されているバックエンド側 API へ、入力されたアンケート回答内容を POST しています。
